...
INSERT INTO `ClimbersSoulRules` (`id`, `order`, `parentOrder`, `content`) VALUES
(1, 1, NULL, 'Il presente regolamento disciplina l''utilizzo da parte del Praticante l''arrampicata sportiva (di seguito "Praticante") della palestra di arrampicata sportiva (di seguito "Palestra"), di proprietà del Comune di Arosio e affidata alla gestione del CAI di Arosio (di seguito "CAI"), sita in Via Buonarroti - Arosio , presso il Palazzetto dello Sport'),
(2, 2, NULL, 'La pratica dell''arrampicata sportiva negli spazi del Palazzetto dello Sport è consentita dopo la presa visione e l''accettazione firmata del presente regolamento. Accettando il presente regolamento il Praticante dichiara di essere in buona salute e di non essere affetto da alcuna patologia incompatibile con la pratica dell''arrampicata sportiva'),
(3, 3, NULL, 'L''accesso alla Palestra è consentito, negli orari che verranno stabiliti, ai soci del Club Alpino Italiano, in regola con il tesseramento per l''anno in corso, previo il pagamento della quota d''uso deliberata dal Consiglio Direttivo della Sezione a titolo di rimborso spese'),
(4, 1, 3, 'Per l''ingresso singolo è previsto un costo di 4€'),
(5, 2, 3, 'Per ingressi multipli, è possibile acquistare un carnet da 5 ingressi a 15€, valido per tutta la stagione di apertura'),
(6, 4, NULL, 'Il "CAI" non svolge alcuna attività di istruzione o di ausilio alla attività di arrampicata, che viene quindi svolta dal "Praticante" in modo autonomo o insieme a compagni di cordata, da lui scelti in totale autonomia e delle cui capacità ed esperienza il "CAI" non risponde'),
(7, 5, NULL, 'Il "Praticante" è consapevole dei rischi connessi alla pratica dell''arrampicata sportiva e conscio delle necessità di rapportare la propria attività alle proprie capacità tecniche ed alla propria esperienza, nonché a quella dei compagni di cordata prescelti'),
(8, 6, NULL, 'Il "Praticante" è esclusivamente responsabile dell''adeguatezza, della qualità e delle conformità alle norme CE delle attrezzature individuali e di cordata che introduce ed utilizza nella "Palestra"'),
(9, 7, NULL, 'Il "CAI" garantisce la presenza costante all''interno della Palestra presso il Palazzetto dello Sport di personale formato per la gestione di eventuali emergenze di natura tecnica e per l''attivazione dei soccorsi in caso di emergenza sanitaria'),
(10, 8, NULL, 'Il "CAI" non è responsabile della custodia dei materiali e di qualunque altro bene di proprietà del "Praticante" durante la permanenza all''interno della "Palestra" e nel posteggio antistante'),
(11, 9, NULL, 'I minorenni, per la frequentazione dell''area di arrampicata con la corda, devono obbligatoriamente essere accompagnati ed assistiti da un genitore, firmatario del presente regolamento. E'' onere del genitore, firmatario del presente regolamento, verificare che il minorenne abbia compreso correttamente le modalità di utilizzo della struttura così come indicate nel presente regolamento. E'' fatto divieto per i MINORI di 16 anni, assicurare chi arrampica, anche se è il genitore stesso'),
(12, 10, NULL, 'Il "Praticante" esonera espressamente il "CAI" da qualunque responsabilità per i danni che gli possono derivare in conseguenza della propria attività di arrampicata o di collaborazione ed ausilio dell''attività di arrampicata altrui ed è esclusivamente responsabile per quelli che possono derivare ad altri frequentatori della "Palestra"'),
(13, 11, NULL, 'Il "Praticante" si impegna all''osservanza delle seguenti norme comportamentali:'),
(14, 1, 11, 'L''ingresso della "Palestra" è consentito unicamente previa esibizione della tessera CAI in corso di validità unitamente a documento di identità e  tessera di accesso personale e non cedibile. Il personale del "CAI" che venga a conoscenza della violazione dell''obbligo di non cedere la tessera a terzi è autorizzato a chiedere la restituzione della tessera stessa, senza che ciò derivi per il "CAI" l''obbligo di restituire al "Praticante" il corrispettivo già versato'),
(15, 2, 11, 'Il "Praticante" durante l''attività all''interno della "Palestra" deve adottare un comportamento educato, diligente e igienico'),
(16, 3, 11, 'All''interno della "Palestra" è vietato fumare, introdurre animali e in generale, svolgere qualunque attività incompatibile con l''arrampicata'),
(17, 4, 11, 'Il materiale, la struttura d''arrampicata e i servizi igienici vanno lasciati in perfetto ordine. Al termine dell''utilizzo tutti i locali devono essere lasciati puliti'),
(18, 5, 11, 'Il personale di servizio del "CAI" è autorizzato ad allontanare il "Praticante" dalla "Palestra" qualora questo ponga in essere un comportamento non conforme al presente regolamento, senza che ciò comporti per il "CAI" l''obbligo di restituire al "Praticante" il corrispettivo già versato. Il "Praticante" è altresì tenuto ad attenersi a quanto indicato dal personale di servizio'),
(19, 12, NULL, 'Il "Praticante" si impegna all''osservanza delle seguenti norme tecniche:'),
(20, 1, 12, 'L''accesso alla struttura è consentito solo utilizzando scarpe da ginnastica pulite ed asciutte, mentre alla "Palestra di arrampicata" è consentito solo utilizzando scarpe da arrampicata anche esse pulite ed asciutte'),
(21, 2, 12, 'All''interno della "Palestra" è fatto obbligo a tutti gli arrampicatori di utilizzare esclusivamente magnesite in palline. E'' vietato introdurre magnesite in polvere'),
(22, 3, 12, 'E'' vietato al "Praticante" posizionare prese e connettori di sicurezza, tracciare vie e spostare prese '),
(23, 4, 12, 'Il "Praticante" deve segnalare al personale del "CAI" l''eventuale presenza di appigli e appoggi allentati'),
(24, 5, 12, 'Nell''area con corda è consentito arrampicare per ciascuna via ad una cordata per volta, composta da un assicuratore ed un salitore'),
(25, 6, 12, 'Nell''area con corda è vietato arrampicare sopra persone che stazionano nella possibile zona di caduta e nella direzione di caduta di chi si trova più in alto'),
(26, 7, 12, 'La salita da capo cordata è possibile nei percorsi stabiliti impiegando la corda personale. E'' consentito il solo uso di corde intere dinamiche omologate di lunghezza uguale o superiore a 20 m (non sono ammesse mezze corde), legate direttamente all''imbragatura con nodo a otto o bulino infilato ed utilizzando tutti i rinvii intermedi per assicurarsi correttamente con la corda. L''assicurazione dell''arrampicatore deve essere effettuata con attrezzi di assicurazione autobloccanti omologati. Raggiunta la sommità dell''itinerario è obbligatorio far passare la corda in entrambi i moschettoni dell''ancoraggio finale'),
(27, 8, 12, 'Nell''area con corda il "Praticante" che assicura deve posizionarsi alla base del muro e prestare la massima attenzione durante l''arrampicata del proprio compagno. Ai fini della sicurezza, sarebbe opportuno che chi assicura non abbia un peso eccessivamente inferiore a chi sta salendo');
